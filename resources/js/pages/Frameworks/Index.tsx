...
const jurisdictionFlags: Record<string, string> = {
  ...
  'Angola': 'ao', 'Benin': 'bj', 'Bénin': 'bj', 'Botswana': 'bw',
  ...
  'Gabon': 'ga', 'Gambie': 'gm', 'Gambia': 'gm',
  'Ghana': 'gh', 'Guinée': 'gn', 'Guinea': 'gn',
  'Guinée-Bissau': 'gw', 'Guinea-Bissau': 'gw',
  'Kenya': 'ke', 'Lesotho': 'ls', 'Libéria': 'lr', 'Liberia': 'lr',
  'Libye': 'ly', 'Libya': 'ly',
  'Madagascar': 'mg', 'Malawi': 'mw', 'Mali': 'ml',
  'Mauritanie': 'mr', 'Mauritania': 'mr',
  'Maurice': 'mu', 'Mauritius': 'mu',
  'Maroc': 'ma', 'Morocco': 'ma',
  'Mozambique': 'mz', 'Namibie': 'na', 'Namibia': 'na',
  'Niger': 'ne', 'Nigeria': 'ng', 'Nigéria': 'ng',
  'Rwanda': 'rw', 'Sénégal': 'sn', 'Senegal': 'sn',
  ...
  'Zambie': 'zm', 'Zambia': 'zm', 'Zimbabwe': 'zw',
  ...
  'Chili': 'cl', 'Chile': 'cl', 'Colombie': 'co', 'Colombia': 'co',
  'Équateur': 'ec', 'Equateur': 'ec', 'Ecuador': 'ec',
  'Guyana': 'gy', 'Paraguay': 'py',
  'Pérou': 'pe', 'Perou': 'pe', 'Peru': 'pe',
  ...
  'Norvège': 'no', 'Norvege': 'no', 'Norway': 'no',
  ...
  'Union européenne': 'eu', 'Union Europeenne': 'eu', 'European Union': 'eu',
};
