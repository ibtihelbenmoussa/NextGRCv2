...
interface MacroProcessShowProps {
    macroProcess: MacroProcess;
}

export default function MacroProcessShow({
    macroProcess,
}: MacroProcessShowProps) {
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: macroProcess.name, href: '' },
            ]}
        >
            <Head title={macroProcess.name} />
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    <div className="flex-1 space-y-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-sm text-muted-foreground md:gap-4">
                            <span>Code: {macroProcess.code}</span>
                            {macroProcess.business_unit && (
                                <>
                                    <span className="hidden md:inline">•</span>
                                    <span>
                                        {macroProcess.business_unit.name}
                                    </span>
                                </>
                            )}
                        </div>
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            <Link
                                href={`/macro-processes/${macroProcess.id}/edit`}
                            >
                ...
                <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3">
                    ...
                    <div className="rounded-lg border p-3">
                        ...
                        <div className="mt-1">
                            ...
                            macroProcess.managers.length > 0 ? (
                                <div className="flex flex-wrap gap-1">
                                    {macroProcess.managers.map((manager) => (
                                        <Badge
                                            key={manager.id}
                                            variant="outline"
                                            className="text-xs"
                ...
                <Tabs defaultValue="processes" className="space-y-4">
                    ...
                    <TabsContent value="processes" className="space-y-4">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            >
                                <Link
                                    href={`/processes/create?macro_process_id=${macroProcess.id}`}
                                >
                    ...
                    <TabsContent value="documents" className="space-y-4">
                        ...
                        macroProcess.documents.length > 0 ? (
                            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                                {macroProcess.documents.map((document) => (
                                    <div
                                        key={document.id}
                    ...
                    <TabsContent value="bpmn" className="space-y-4">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            >
                                <Link
                                    href={`/bpmn-diagrams/create?macro_process_id=${macroProcess.id}`}
                                >
                                    <Plus className="mr-2 h-4 w-4" />
                                    Add Diagram
                                </Link>
                        ...
                        {macroProcess.bpmn_diagrams &&
                        macroProcess.bpmn_diagrams.length > 0 ? (
                            <>
                                {/* Desktop Table View */}
                                <div className="hidden rounded-lg border md:block">
                                    <Table>
                                        ...
                                        <TableBody>
                                            {macroProcess.bpmn_diagrams.map(
                                                (diagram) => (
                                                    <TableRow
                                                        key={diagram.id}
                                                        className="cursor-pointer"
                            ...
                            <div className="rounded-lg border border-dashed p-8 text-center md:p-12">
                                ...
                                <p className="mt-2 text-sm text-muted-foreground">
                                    Create BPMN diagrams to visualize your macro
                                    process flows.
                                </p>
                                <Button className="mt-4" size="sm" asChild>
                                    <Link
