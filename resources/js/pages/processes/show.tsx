                    ...
                    <div className="flex-1 space-y-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
                            ...
                            {process.macro_process?.business_unit && (
                                <>
                                    <span className="hidden md:inline">•</span>
                                    <span>{process.macro_process.business_unit.name}</span>
                                </>
                            )}
                        </div>
                        {process.description && (
                        ...
                        {process.objectives && (
                            <div className="mt-2 max-w-2xl rounded-lg border bg-muted/50 p-3">
                                ...
                                <p className="text-sm text-muted-foreground">{process.objectives}</p>
                            </div>
                        )}
                    </div>
                ...
                <Tabs defaultValue="documents" className="space-y-4">
                    <TabsList>
                        ...
                        <TabsTrigger value="bpmn">
                            ...
                            BPMN Diagrams
                            {process.bpmn_diagrams && process.bpmn_diagrams.length > 0 && (
                                <Badge variant="secondary" className="ml-2">
                                    {process.bpmn_diagrams.length}
                                </Badge>
                            )}
                        </TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="documents" className="space-y-4">
                        ...
                        {process.documents && process.documents.length > 0 ? (
                            ...
                            <div className="rounded-lg border border-dashed p-8 text-center md:p-12">
                                ...
                                <h3 className="mt-4 text-base font-semibold md:text-lg">No documents yet</h3>
                    ...
                    <TabsContent value="bpmn" className="space-y-4">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <h2 className="text-lg font-semibold">BPMN Diagrams</h2>
                            <Button size="sm" asChild className="w-full sm:w-auto">
                                <Link href={`/bpmn-diagrams/create?process_id=${process.id}`}>
                        ...
                        {process.bpmn_diagrams && process.bpmn_diagrams.length > 0 ? (
                                        ...
                                        <TableBody>
                                            {process.bpmn_diagrams.map((diagram) => (
                                                <TableRow
                                                    ...
                                                    onClick={() => (window.location.href = `/bpmn-diagrams/${diagram.id}`)}
                                                >
                            ...
                            <div className="rounded-lg border border-dashed p-8 text-center md:p-12">
                                ...
                                <h3 className="mt-4 text-base font-semibold md:text-lg">No BPMN diagrams yet</h3>
                                <p className="mt-2 text-sm text-muted-foreground">
                                    Create BPMN diagrams to visualize your process flows.
                                </p>
