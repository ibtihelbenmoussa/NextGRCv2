...
const TreeView = React.forwardRef<HTMLDivElement, TreeProps>(
    (
        ...
        const expandedItemIds = React.useMemo(() => {
            ...
            // If expandAll is true, collect all node IDs that have children
            if (expandAll) {
                const collectAllNodeIds = (items: TreeDataItem[] | TreeDataItem) => {
                    if (Array.isArray(items)) {
                        ...
                        ids.push(items.id)
                        collectAllNodeIds(items.children)
                    }
                }
            ...
            // Original logic for expanding to selected item
            if (initialSelectedItemId) {
                function walkTreeItems(
                    ...
                    } else if (walkTreeItems(items.children, targetId)) {
                        return true
                    }
                    return false
                }
